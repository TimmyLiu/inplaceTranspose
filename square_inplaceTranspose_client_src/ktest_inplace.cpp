...
//const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_1024.cl";
//const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_1024_LDS.cl";
const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_1024_LDS1.cl";
//const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_2048.cl";
//const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_4096.cl";
//const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_4096_LDS.cl";
//const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_4064.cl";
//const char KERNEL_SOURCE[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranspose_client_src\\clfft.kernel.Transpose2_real_general.cl";
...
int main(int argc, char **argv)
{
	...
	size_t globalWorkSize[1] = { batchSize * num_wg * 256 };//528 * 256
	...
	if (performance_level == 0)
	{
		...
		for (int k = 0; k < batchSize; k++)
		{
			for (int i = 0; i < m; i++)
			{
				for (int j = 0; j < n; j++)
				{
					float temp = CPU_A[i*n + j];
					if (CPU_A[k*m*n + i*n + j] != (j*n + i))
					{

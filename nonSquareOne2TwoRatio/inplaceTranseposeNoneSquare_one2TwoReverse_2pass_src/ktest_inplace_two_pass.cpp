...
const char KERNEL_SOURCE1[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranseposeNoneSquare_one2TwoReverse_2pass_src\\TransposeNonSquareSwapLines.cl";
const char KERNEL_SOURCE2[] = "C:\\Users\\timmy\\Documents\\inplaceTranspose_client\\inplaceTranseposeNoneSquare_one2TwoReverse_2pass_src\\clfft.kernel.Transpose2.cl";
cl_kernel
createKernel(
	const char* source,
	cl_context context,
...
int main(int argc, char **argv)
{
	...
	size_t globalWorkSize2[1] = { batchSize * num_wg * miniBatchSize * 256 };//528 * 256 * 2
	...
	*/
	...
	size_t globalWorkSize1[1] = { batchSize*((n-2)/11)*256 }; // 2046 / 11 = 186; each WG takes care of 11 rows of 1024 long memory; each WI takes care of 44 element
